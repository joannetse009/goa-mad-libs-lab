...
public class ResultActivity extends AppCompatActivity {
    ...
    private SpannableStringBuilder generateStory(ArrayList<String> storyWords) {
        ...
        for (int ind = 0; ind < storyWords.size(); ind++) {
            SpannableString phrase = new SpannableString(storyPhrases[ind]);
            SpannableString word = new SpannableString(storyWords.get(ind));
